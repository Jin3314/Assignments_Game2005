...
Target::Target()
{
	TextureManager::Instance()->load("../Assets/textures/grenade.png","grenade");

	const auto size = TextureManager::Instance()->getTextureSize("grenade");
	setWidth(size.x);
	setHeight(size.y);
...
void Target::draw()
{
	...
	// draw the target
	TextureManager::Instance()->draw("grenade", x, y, 0, 255, true);
}
